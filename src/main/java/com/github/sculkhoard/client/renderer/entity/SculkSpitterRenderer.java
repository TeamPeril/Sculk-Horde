...
import com.github.sculkhoard.client.model.enitity.SculkSpitterModel;
...
public class SculkSpitterRenderer extends GeoEntityRenderer<SculkSpitterEntity> {
    ...
    public SculkSpitterRenderer(EntityRendererManager renderManager)
    {
    ...
    @Override
    public RenderType getRenderType(SculkSpitterEntity animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
