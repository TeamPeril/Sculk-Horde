...
public class ModItems {
	...
	public static final RegistryObject<ForgeSpawnEggItem> SCULK_BROOD_SPITTER_SPAWN_EGG = ITEMS.register("sculk_brood_spitter_spawn_egg",() ->  new ForgeSpawnEggItem(ModEntities.SCULK_BROOD_SPITTER, hexToInt(ColorUtil.sculkBoneColor6), hexToInt(ColorUtil.sculkLightColor1), new Item.Properties()));
