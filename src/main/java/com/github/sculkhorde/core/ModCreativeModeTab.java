...
public class ModCreativeModeTab {
	...
	{
		register.registerCreativeModeTab(new ResourceLocation(SculkHorde.MOD_ID, "sculk_horde_tab"), builder -> builder
	            .title(Component.translatable("itemGroup.sculkhorde_tab"))
	            .icon(() -> new ItemStack(ModBlocks.SCULK_ANCIENT_NODE_BLOCK.get())).displayItems((enabledFeatures, event) -> {
	                ...
	                if(!FMLLoader.isProduction()) event.accept(ModItems.CHUNK_O_BRAIN.get());
	                if(!FMLLoader.isProduction()) event.accept(ModItems.DORMANT_HEART_OF_THE_HORDE.get());
