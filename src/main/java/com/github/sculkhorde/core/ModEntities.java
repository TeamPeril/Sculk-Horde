...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<SculkBroodSpitterEntity>> SCULK_BROOD_SPITTER = registerMob("sculk_brood_spitter", SculkBroodSpitterEntity::new, 1.4f, 0.9f, 0x000000, 0x000000);
