...
public class SculkRavagerRenderer extends GeoEntityRenderer<SculkRavagerEntity> {
    ...
    public SculkRavagerRenderer(EntityRendererManager renderManager)
    {
    ...
    @Override
    public RenderType getRenderType(SculkRavagerEntity animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
