...
public class SculkBeeInfectorRenderer extends GeoEntityRenderer<SculkBeeInfectorEntity> {
    ...
    public SculkBeeInfectorRenderer(EntityRendererManager renderManager)
    {
    ...
    @Override
    public RenderType getRenderType(SculkBeeInfectorEntity animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
