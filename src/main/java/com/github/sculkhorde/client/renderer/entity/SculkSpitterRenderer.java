...
public class SculkSpitterRenderer extends GeoEntityRenderer<SculkSpitterEntity> {
    ...
    public SculkSpitterRenderer(EntityRenderDispatcher renderManager)
    {
    ...
    @Override
    public RenderType getRenderType(SculkSpitterEntity animatable, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
