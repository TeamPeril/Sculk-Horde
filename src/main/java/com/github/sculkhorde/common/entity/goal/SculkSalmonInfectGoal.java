...
public class SculkSalmonInfectGoal extends MeleeAttackGoal {

    private final SculkSalmonEntity mob;
     ...
     */
    public SculkSalmonInfectGoal(SculkSalmonEntity mob, double speedModifier, boolean followTargetIfNotSeen) {
    ...
    public void tick()
    {
        ...
        SculkSalmonEntity thisMob = this.mob;
